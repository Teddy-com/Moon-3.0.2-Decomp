...
public class MVArraylistComponent
extends Component {
    @Override
    public void render(Render2DEvent event) {
        ...
        for (Module module2 : modules) {
            ...
            this.mc.fontRendererObj.drawStringWithShadow(moduleString, module2.isEnabled() ? (float)sr.getScaledWidth() - (float)this.mc.fontRendererObj.getStringWidth(moduleString) + module2.offset - 3.0f : (float)sr.getScaledWidth() + module2.offset + 5.0f, yPos, -46775);
            yPos += module2.isEnabled() ? 11.0f - MVArraylistComponent.map(module2.offset, 0.0f, this.mc.fontRendererObj.getStringWidth(moduleString), 0.0f, 11.0f) : -MVArraylistComponent.map(module2.offset, 0.0f, this.mc.fontRendererObj.getStringWidth(moduleString), 0.0f, 11.0f);
