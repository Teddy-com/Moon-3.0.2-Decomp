...
public class PotionHUDAddButton
extends AddButton {
    public PotionHUDAddButton(float posY) {
        super("Add PotionHUD", posY);
    }
    ...
    public void onRun() {
        ...
        Moon.INSTANCE.getComponentManager().initComp(new PotionComponent("PotionHUD" + ok));
    }
}
