...
public class ArmorHUDAddButton
extends AddButton {
    public ArmorHUDAddButton(float posY) {
        super("Add ArmorHUD", posY);
    }
    ...
    public void onRun() {
        ...
        Moon.INSTANCE.getComponentManager().initComp(new ArmorComponent("ArmorHUD" + ok));
    }
}
