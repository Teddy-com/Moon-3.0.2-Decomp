...
public class TargetHUDAddButton
extends AddButton {
    public TargetHUDAddButton(float posY) {
        super("Add TargetHUD", posY);
    }
    ...
    public void onRun() {
        ...
        Moon.INSTANCE.getComponentManager().initComp(new TargetHUDComponent("TargetHUD" + ok));
    }
}
