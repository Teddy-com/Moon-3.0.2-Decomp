...
extends Gui {
    ...
    public GuiLoginField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtil.drawRoundedRect(this.xPosition + 3, (double)(this.yPosition + this.height) - 4.0, this.width - 6, 0.75, 0.5, -15374912);
            }
            ...
            if (s.length() > 0) {
                ...
                j1 = (int)Fonts.moon.drawStringWithShadow(s1, l, (float)i1 + 1.0f, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = (int)Fonts.moon.drawStringWithShadow(s.substring(j), (float)j1 + 2.0f, (float)i1 + 1.0f, i);
            }
            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1, i1 - 2, k1 + 1, i1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
                } else {
                    Gui.drawRect(k1, i1 - 2, k1 + 1, i1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
                }
            }
            if (k != j) {
                int l1 = l + Fonts.buttonFont.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(k1 + 1, i1 - 1, l1 - 1, i1 + 1 + this.fontRendererInstance.FONT_HEIGHT);
            }
        }
    }
