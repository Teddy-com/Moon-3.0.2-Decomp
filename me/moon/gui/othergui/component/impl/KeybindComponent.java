...
extends Component {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.sectioSmaller.drawString(this.isBinding() ? "Press a key..." : "Bind: " + Keyboard.getKeyName((int)this.getModule().getKeyBind()), this.getFinishedX() + 7.0f, this.getFinishedY() + 0.5f + this.getHeight() / 2.0f - (float)(Fonts.settingsFont2.getStringHeight(this.getLabel()) >> 1), -1);
    }
