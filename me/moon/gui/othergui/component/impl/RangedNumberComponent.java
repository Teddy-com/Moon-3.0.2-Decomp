...
extends Component {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        float startX = this.getFinishedX() + 1.0f;
        float sliderwidth = this.getWidth() - 2.0f;
        ...
        RenderUtil.drawRect(this.getFinishedX() + 1.0f + leftX, this.getFinishedY() + 1.0f, rightX - leftX, this.getHeight() - 2.0f, (Integer)clickGUI.color.getValue());
        Fonts.astolfoFont.drawStringWithShadow(this.getLabel() + " " + this.rangedValue.getLeftValue().toString() + " / " + this.rangedValue.getRightValue().toString() + "", this.getFinishedX() + 5.0f, this.getFinishedY() + this.getHeight() / 2.0f - (float)Fonts.astolfoFont.getStringHeight(this.getLabel()) / 2.0f + 0.5f, -1);
