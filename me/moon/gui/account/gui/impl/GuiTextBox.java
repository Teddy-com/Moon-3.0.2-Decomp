...
extends Gui {
    ...
    public GuiTextBox(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            RenderUtil.drawBorderedRect(this.xPosition, this.yPosition, this.width, this.height, 1.0, -15374912, -15395563);
