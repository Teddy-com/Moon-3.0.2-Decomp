...
extends Component {
    ...
    public void onDraw(ScaledResolution scaledResolution) {
        ...
        this.animationUtil.interpolate(this.getPosX() + (float)(this.parentComponent.getSelectedValue() == this.getNumberValue() ? 5 : 2) - 20.0f, 0.0, 14.0f / (float)Minecraft.getDebugFPS());
        FontUtil.drawShadowedString(this.getLabel() + ": " + this.getNumberValue().getValue(), (float)this.animationUtil.getPosX(), this.getPosY() + 2.5f, -1);
    }
