...
public class ShaderLoader {
    ...
    public static ShaderLoader loadShader(IResourceManager resourceManager, ShaderType type, String filename) throws IOException {
        ...
        if (shaderloader == null) {
            ResourceLocation resourcelocation = new ResourceLocation((filename.contains("blur") ? "textures/client/program/" : "shaders/program/") + filename + type.getShaderExtension());
