...
IPlayerUsage {
    ...
    public FontRenderer fontRendererObjCustom;
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.fontRendererObjCustom = new FontRenderer(this.gameSettings, new ResourceLocation("textures/client/bit.png"), this.renderEngine, false);
        if (this.gameSettings.language != null) {
            this.fontRendererObjCustom.setUnicodeFlag(this.isUnicode());
            this.fontRendererObjCustom.setBidiFlag(this.mcLanguageManager.isCurrentLanguageBidirectional());
        }
        this.standardGalacticFontRenderer = new FontRenderer(this.gameSettings, new ResourceLocation("textures/font/ascii_sga.png"), this.renderEngine, false);
        this.mcResourceManager.registerReloadListener(this.fontRendererObj);
        this.mcResourceManager.registerReloadListener(this.fontRendererObjCustom);
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn) {
        ...
        this.fromMainMenu = this.currentScreen instanceof GuiMainMenu;
        GuiScreen prevScreen = this.currentScreen;
    ...
    protected void checkWindowResize() {
        if (!this.fullscreen && Display.wasResized()) {
            ResizeEvent event = new ResizeEvent(this.displayWidth, this.displayHeight, true);
    ...
    private void sendClickBlockToController(boolean leftClick) {
        ...
        if (leftClickCounter <= 0 && !this.thePlayer.isUsingItem()) {
    ...
    private void clickMouse() {
        ...
        Moon.INSTANCE.getEventBus().fireEvent(new ClickMouseEvent());
    ...
    private void resize(int width, int height) {
        ...
        if (this.currentScreen != null) {
            ...
            ResizeEvent postEvent = new ResizeEvent(width, height, false);
            Moon.INSTANCE.getEventBus().fireEvent(postEvent);
        }
        this.loadingScreen = new LoadingScreenRenderer(this);
        this.updateFramebufferSize();
    }
    ...
    public void runTick() throws IOException {
        Moon.INSTANCE.getEventBus().fireEvent(new TickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    ...
                    Moon.INSTANCE.getEventBus().fireEvent(eventMouse);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    Moon.INSTANCE.getEventBus().fireEvent(new KeyInputEvent(k));
                    KeyBinding.onTick(k);
                }
            ...
            if (this.gameSettings.keyBindUseItem.isKeyDown()) {
                if (rightClickDelayTimer == 0 && !this.thePlayer.isUsingItem()) {
                    this.rightClickMouse();
                }
            }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            WorldLoadEvent eventWorldLoad = new WorldLoadEvent(worldClientIn);
            Moon.INSTANCE.getEventBus().fireEvent(eventWorldLoad);
        } else {
