...
implements Comparable<KeyBinding> {
    ...
    public static void unPressAllKeys() {
        for (KeyBinding keybinding : keybindArray) {
            if (Moon.INSTANCE.getModuleManager().getModule("InvWalk").isEnabled()) {
                Minecraft mc = Minecraft.getMinecraft();
                if ((keybinding == mc.gameSettings.keyBindForward || keybinding == mc.gameSettings.keyBindLeft || keybinding == mc.gameSettings.keyBindRight || keybinding == mc.gameSettings.keyBindBack) && !(mc.currentScreen instanceof GuiChat)) continue;
            }
