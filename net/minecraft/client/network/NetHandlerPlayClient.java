...
implements INetHandlerPlayClient {
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
        ...
        this.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(entityplayer.posX, entityplayer.getEntityBoundingBox().minY, entityplayer.posZ, entityplayer.rotationYaw, entityplayer.rotationPitch, false));
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        PacketEvent event = new PacketEvent(p_147297_1_, true);
        ...
        if (!event.isCancelled()) {
            ...
            if (p_147297_1_ instanceof C03PacketPlayer.C05PacketPlayerLook) {
                packet = (C03PacketPlayer.C05PacketPlayerLook)p_147297_1_;
            ...
            if (p_147297_1_ instanceof C03PacketPlayer.C06PacketPlayerPosLook) {
                packet = (C03PacketPlayer.C06PacketPlayerPosLook)p_147297_1_;
                Minecraft.getMinecraft().thePlayer.rotationYawHead = packet.getYaw();
            }
        }
    }
    ...
    public void handleTimeUpdate(S03PacketTimeUpdate packetIn) {
        ...
        if (!Moon.INSTANCE.getModuleManager().getModule("TimeChanger").isEnabled()) {
