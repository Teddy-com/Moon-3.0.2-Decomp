...
import me.moon.Moon;
import me.moon.event.impl.game.EntitySpawnEvent;
...
extends World {
    ...
    public void addEntityToWorld(int p_73027_1_, Entity p_73027_2_) {
        Entity entity;
        if (p_73027_2_ instanceof EntityLivingBase) {
            EntitySpawnEvent entitySpawnEvent = new EntitySpawnEvent((EntityLivingBase)p_73027_2_);
            Moon.INSTANCE.getEventBus().fireEvent(entitySpawnEvent);
            if (entitySpawnEvent.isCancelled()) {
                return;
            }
        }
        if ((entity = this.getEntityByID(p_73027_1_)) != null) {
