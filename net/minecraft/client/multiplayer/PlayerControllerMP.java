...
public class PlayerControllerMP {
    ...
    public static Float survivalBlockReach;
    ...
    public float getBlockReachDistance() {
        return this.currentGameType.isCreative() ? 5.0f : survivalBlockReach.floatValue();
    }
    ...
    public ItemStack windowClick(int windowId, int slotId, int mouseButtonClicked, int mode2, EntityPlayer playerIn) {
        short short1 = playerIn.openContainer.getNextTransactionID(playerIn.inventory);
        ItemStack itemstack = playerIn.openContainer.slotClick(slotId, mouseButtonClicked, mode2, playerIn);
        this.netClientHandler.addToSendQueue(new C0EPacketClickWindow(windowId, slotId, mouseButtonClicked, mode2, itemstack, short1));
        return itemstack;
    }
