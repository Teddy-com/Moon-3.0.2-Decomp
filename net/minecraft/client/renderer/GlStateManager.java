...
public class GlStateManager {
    ...
    public static void colorMaterial(int face, int mode2) {
        if (face != GlStateManager.colorMaterialState.field_179189_b || mode2 != GlStateManager.colorMaterialState.field_179190_c) {
            GlStateManager.colorMaterialState.field_179189_b = face;
            GlStateManager.colorMaterialState.field_179190_c = mode2;
            GL11.glColorMaterial((int)face, (int)mode2);
        }
    }
    ...
    public static void cullFace(int mode2) {
        if (mode2 != GlStateManager.cullState.field_179053_b) {
            GlStateManager.cullState.field_179053_b = mode2;
            GL11.glCullFace((int)mode2);
        }
    }
    ...
    public static void shadeModel(int mode2) {
        if (mode2 != activeShadeModel) {
            activeShadeModel = mode2;
    ...
    public static void matrixMode(int mode2) {
        GL11.glMatrixMode((int)mode2);
    }
