...
public class ItemRenderer {
    ...
    public void renderItem(EntityLivingBase entityIn, ItemStack heldStack, ItemCameraTransforms.TransformType transform) {
        if (heldStack != null) {
            ...
            if (Moon.INSTANCE.getModuleManager().getModule("ItemSize").isEnabled()) {
                ItemSize itemSize = (ItemSize)Moon.INSTANCE.getModuleManager().getModule("ItemSize");
                float scale = ((Float)itemSize.scale.getValue()).floatValue();
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        if (KillAura.target == null && !this.mc.thePlayer.isBlocking() || !Moon.INSTANCE.getModuleManager().getModule("Killaura").isEnabled() && !this.mc.thePlayer.isBlocking()) {
            delay = 0;
        }
        ...
        if (this.itemToRender != null) {
            ...
            ItemSize itemSize = (ItemSize)Moon.INSTANCE.getModuleManager().getModule("ItemSize");
            if (itemSize.isEnabled()) {
                GlStateManager.translate(((Float)itemSize.x.getValue()).floatValue(), ((Float)itemSize.y.getValue()).floatValue(), 0.0f);
            }
            boolean bl = canAnimate = killAura.isEnabled() && killAura.isAutoBlocking();
            if (this.itemToRender.getItem() instanceof ItemMap) {
                this.renderItemMap(entityplayersp, f2, f, f1);
            } else if (entityplayersp.getItemInUseCount() > 0 || canAnimate) {
                ...
                block0 : switch (enumaction) {
                    ...
                    case BLOCK: {
                        if (Moon.INSTANCE.getModuleManager().getModule("animation").isEnabled()) {
                            Animation animation = (Animation)Moon.INSTANCE.getModuleManager().getModule("animation");
                            GlStateManager.scale(((Float)animation.scale.getValue()).floatValue(), ((Float)animation.scale.getValue()).floatValue(), 1.0f);
                            GlStateManager.translate(((Float)animation.x.getValue()).floatValue() / ((Float)animation.scale.getValue()).floatValue(), -((Float)animation.y.getValue()).floatValue() / ((Float)animation.scale.getValue()).floatValue(), 0.0f);
                            if (animation.getTimerUtil().hasReached(10L)) {
                                delay += ((Integer)Animation.astolfoSpeed.getValue()).intValue();
                                animation.getTimerUtil().reset();
                            }
                            switch ((Animation.mode)((Object)Animation.Mode.getValue())) {
                                case OLD: {
                                    if (!(this.itemToRender.getItem() instanceof ItemSword)) break;
                                    this.transformFirstPersonItem(f - 0.4f, f1);
                                    this.func_178103_d();
                                    break block0;
                                }
                                case NORMAL: {
                                ...
                                case SLIDE: {
                                    ...
                                    this.func_178103_d();
                                    float var9 = MathHelper.sin((float)((double)MathHelper.sqrt_float(f1) * Math.PI));
                                ...
                                case EXHIBITION: {
                                    if (!(this.itemToRender.getItem() instanceof ItemSword)) break;
                                    float f6 = MathHelper.sin((float)((double)MathHelper.sqrt_float(f1) * Math.PI));
                                    GL11.glTranslated((double)-0.1, (double)0.15, (double)0.0);
                                    this.transformFirstPersonItem(f / 2.0f, 0.0f);
                                    GlStateManager.rotate(-f6 * 45.0f / 1.5f, f6 / 1.5f, -0.0f, 9.0f);
                                    GlStateManager.rotate(-f6 * 55.0f, 1.0f, f6 / 2.0f, -0.0f);
                                    this.func_178103_d();
                                    break block0;
                                }
                                case SWANG: {
                                    ...
                                    GlStateManager.rotate(f6 * 30.0f / 2.0f, -f6, -0.0f, 9.0f);
                                ...
                                case SWANK: {
                                    ...
                                    this.transformFirstPersonItem(f / 2.0f, f1);
                                    GL11.glTranslated((double)-0.1, (double)0.15, (double)0.0);
                                    GlStateManager.rotate(f6 * 30.0f, -f6, -0.0f, 9.0f);
                                    GlStateManager.rotate(f6 * 40.0f, 1.0f, -f6, -0.0f);
                                    this.func_178103_d();
                                    break block0;
                                }
                                case OHARE: {
                                    if (!(this.itemToRender.getItem() instanceof ItemSword)) break;
                                    float f6 = MathHelper.sin((float)((double)MathHelper.sqrt_float(f1) * Math.PI));
                                    GL11.glTranslated((double)-0.05, (double)0.0, (double)-0.25);
                                    this.transformFirstPersonItem(f / 2.0f, 0.0f);
                                    GlStateManager.rotate(-f6 * 45.0f, f6, -f6, -(f6 * 2.0f));
                                    this.func_178103_d();
                                    break block0;
                                }
                                case WIZZARD: {
                                    if (!(this.itemToRender.getItem() instanceof ItemSword)) break;
                                    float f6 = MathHelper.sin((float)((double)MathHelper.sqrt_float(f1) * 3.1));
                                ...
                                case LENNOX: {
                                    if (!(this.itemToRender.getItem() instanceof ItemSword)) break;
                                    float angle = (float)Math.cos((double)System.currentTimeMillis() * 0.025 - 0.5);
                                    GL11.glTranslated((double)-0.1, (double)-0.05, (double)0.05);
                                    GlStateManager.rotate(10.0f, 2.0f, 0.0f, 9.0f);
                                    this.transformFirstPersonItem(f / 2.0f, 0.0f);
                                    GlStateManager.rotate(5.0f, 2.0f, 0.0f, 9.0f);
                                    GlStateManager.rotate(-angle * 6.0f + 5.0f, 2.0f, 0.0f, 9.0f);
                                    GlStateManager.rotate(-angle * 6.0f + 6.0f, 1.0f, 2.0f, 0.0f);
                                    this.func_178103_d();
                                    break block0;
                                }
                                case ASTOLFOSPINNY: {
                                    this.transformFirstPersonItem(f, 0.0f);
                                    GlStateManager.rotate(-100.0f, -4.5f, -1.5f, 10.0f);
                                    GlStateManager.rotate(delay % 360, delay % 360, 0.0f, delay % 360);
                                    this.func_178103_d();
                                    break block0;
                                }
                                case XIV: {
                                    ...
                                    this.transformFirstPersonItem(f, 0.0f);
                                    this.func_178103_d();
                                    float var14 = MathHelper.sin((float)((double)(f1 * f1) * Math.PI));
                                ...
                                case Custom: {
                                    if (!(this.itemToRender.getItem() instanceof ItemSword)) break;
                                    this.transformFirstPersonItem(f + 1.0f, f1);
                                    this.func_178103_d();
                                    break block0;
                                }
                                case ASTOLFOSPIN: {
                                    GlStateManager.rotate(delay % 360, 0.0f, 0.0f, -0.1f);
