...
import me.moon.utils.render.ItemPhysic;
...
extends Render<EntityItem> {
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ItemPhysics itemPhysics = (ItemPhysics)Moon.INSTANCE.getModuleManager().getModule("ItemPhysics");
        if (itemPhysics.isEnabled()) {
            ItemPhysic.doRender(entity, x, y, z, entityYaw, partialTicks);
        } else {
