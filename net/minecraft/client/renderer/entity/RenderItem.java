...
implements IResourceManagerReloadListener {
    ...
    private void renderEffect(IBakedModel model) {
        if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
            ...
            if (!Config.isShaders() && RenderManager.renderEnchant || !Shaders.isShadowPass && RenderManager.renderEnchant) {
                ...
                int color = -8372020;
                if (Moon.INSTANCE.getModuleManager().getModule("Glint").isEnabled()) {
                    color = (Integer)Glint.colorValue.getValue();
                }
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, float xPosition, float yPosition, String text) {
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                ...
                GlStateManager.disableBlend();
                fr.drawStringWithShadow(s, xPosition + 19.0f - 2.0f - (float)fr.getStringWidth(s), yPosition + 6.0f + 3.0f, 0xFFFFFF);
                GlStateManager.enableLighting();
            ...
            if (flag) {
                int i = (int)Math.round(13.0 - (double)stack.getItemDamage() * 13.0 / (double)stack.getMaxDamage());
                int j = (int)Math.round(255.0 - (double)stack.getItemDamage() * 255.0 / (double)stack.getMaxDamage());
                ...
                Tessellator tessellator = Tessellator.getInstance();
                WorldRenderer worldrenderer = tessellator.getWorldRenderer();
                this.func_181565_a(worldrenderer, xPosition + 2.0f, yPosition + 13.0f, 13, 2, 0, 0, 0, 255);
                this.func_181565_a(worldrenderer, xPosition + 2.0f, yPosition + 13.0f, 12, 1, (255 - j) / 4, 64, 0, 255);
                this.func_181565_a(worldrenderer, xPosition + 2.0f, yPosition + 13.0f, i, 1, 255 - j, j, 0, 255);
    ...
    private void func_181565_a(WorldRenderer p_181565_1_, float p_181565_2_, float p_181565_3_, int p_181565_4_, int p_181565_5_, int p_181565_6_, int p_181565_7_, int p_181565_8_, int p_181565_9_) {
        p_181565_1_.begin(7, DefaultVertexFormats.POSITION_COLOR);
        p_181565_1_.pos(p_181565_2_ + 0.0f, p_181565_3_ + 0.0f, 0.0).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        p_181565_1_.pos(p_181565_2_ + 0.0f, p_181565_3_ + (float)p_181565_5_, 0.0).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        p_181565_1_.pos(p_181565_2_ + (float)p_181565_4_, p_181565_3_ + (float)p_181565_5_, 0.0).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
        p_181565_1_.pos(p_181565_2_ + (float)p_181565_4_, p_181565_3_ + 0.0f, 0.0).color(p_181565_6_, p_181565_7_, p_181565_8_, p_181565_9_).endVertex();
