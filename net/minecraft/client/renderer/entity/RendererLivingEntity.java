...
extends Render<T> {
    ...
    public static float pitchHead;
    public static float previousPitchHead;
    public static float yawRender;
    public static float previousYawRender;
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if (chams.isEnabled() && !chams.shader.isEnabled() && chams.chamsModes.getValue() == Chams.Modes.TEXTURE && chams.isValid((EntityLivingBase)entity)) {
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, x, y, z)) {
            ...
            try {
                ...
                if (entity == Minecraft.getMinecraft().thePlayer) {
                    f1 = RendererLivingEntity.getPreviousYawRender() + (RendererLivingEntity.getYawRender() - RendererLivingEntity.getPreviousYawRender()) * partialTicks;
                }
                float f2 = f1 - f;
                ...
                if (entity == Minecraft.getMinecraft().thePlayer) {
                    f8 = RendererLivingEntity.getPreviousPitchHead() + (RendererLivingEntity.getPitchHead() - RendererLivingEntity.getPreviousPitchHead()) * partialTicks;
                }
                ...
                if (this.renderOutlines) {
                    ...
                    if (!(entity instanceof EntityPlayer) || !((EntityPlayer)entity).isSpectator()) {
                        OutlineESP outlineESP = (OutlineESP)Moon.INSTANCE.getModuleManager().getModule("OutlineESP");
                        if (RenderManager.renderLayers) {
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        ...
        if (flag || flag1) {
            ...
            if (esp.isEnabled() && esp.modes.getValue() == ESP.mode.XTASY && esp.isValid((EntityLivingBase)entitylivingbaseIn)) {
                GL11.glPushMatrix();
            ...
            RenderEntityModelEvent entityModelEvent = new RenderEntityModelEvent(true, (EntityLivingBase)entitylivingbaseIn, this.mainModel, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
            Moon.INSTANCE.getEventBus().fireEvent(entityModelEvent);
            this.mainModel.render((Entity)entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
            RenderEntityModelEvent renderEntityModelEvent = new RenderEntityModelEvent(false, (EntityLivingBase)entitylivingbaseIn, this.mainModel, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
            Moon.INSTANCE.getEventBus().fireEvent(renderEntityModelEvent);
            if (flag1) {
    ...
    protected boolean setBrightness(T entitylivingbaseIn, float partialTicks, boolean combineTextures) {
        ...
        boolean bl = flag1 = ((EntityLivingBase)entitylivingbaseIn).hurtTime > 0 && RenderManager.renderLayers || ((EntityLivingBase)entitylivingbaseIn).deathTime > 0 && RenderManager.renderLayers;
        if (!flag && !flag1) {
            return false;
        }
    ...
    public void renderName(T entity, double x, double y, double z) {
        NameplateEvent event = new NameplateEvent((Entity)entity);
    ...
    public static void setPreviousYawRender(float previousYawRender) {
        RendererLivingEntity.previousYawRender = previousYawRender;
    }

    public static void setYawRender(float yawRender) {
        RendererLivingEntity.yawRender = yawRender;
    }

    public static float getYawRender() {
        return yawRender;
    }

    public static float getPreviousYawRender() {
        return previousYawRender;
    }

    public static void setPitchHead(float pitchHead) {
        RendererLivingEntity.pitchHead = pitchHead;
    }

    public static void setPreviousPitchHead(float previousPitchHead) {
        RendererLivingEntity.previousPitchHead = previousPitchHead;
    }
