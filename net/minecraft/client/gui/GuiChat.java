...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.inputField.getText().startsWith("-")) {
            RenderUtil.drawBorderedRect(2.0, this.height - 14, this.width - 4, 12.0, 1.0, -15374912, -1441438272);
        }
        GuiChat.drawRect(2.0, this.height - 14, this.width - 2, this.height - 2, this.inputField.getText().startsWith("-") ? 0 : Integer.MIN_VALUE);
