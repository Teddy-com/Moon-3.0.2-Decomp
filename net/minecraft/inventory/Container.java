...
public abstract class Container {
    ...
    public ItemStack slotClick(int slotId, int clickedButton, int mode2, EntityPlayer playerIn) {
        ...
        if (mode2 == 5) {
            ...
            this.resetDrag();
        } else if (!(mode2 != 0 && mode2 != 1 || clickedButton != 0 && clickedButton != 1)) {
            if (slotId == -999) {
        ...
        } else if (mode2 == 2 && clickedButton >= 0 && clickedButton < 9) {
        ...
        } else if (mode2 == 3 && playerIn.capabilities.isCreativeMode && inventoryplayer.getItemStack() == null && slotId >= 0) {
        ...
        } else if (mode2 == 4 && inventoryplayer.getItemStack() == null && slotId >= 0) {
    ...
    protected void retrySlotClick(int slotId, int clickedButton, boolean mode2, EntityPlayer playerIn) {
